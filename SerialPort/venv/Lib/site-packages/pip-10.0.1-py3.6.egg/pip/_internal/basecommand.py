...
class Command(object):
    ...
    def main(self, args):
        ...
        logging_script.config.dictConfig({
            "version": 1,
            "disable_existing_loggers": False,
            "filters": {
                "exclude_warnings": {
                    "()": "pip._internal.utils.logging.MaxLevelFilter",
                    "level": logging_script.WARNING,
                },
            },
            "formatters": {
                "indent": {
        ...
        original_root_handlers = set(logging_script.root.handlers)
        ...
        try:
            ...
            for handler in set(logging_script.root.handlers) - original_root_handlers:
                # this method benefit from the Logger class internal lock
                logging_script.root.removeHandler(handler)
