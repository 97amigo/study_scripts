...
LOGGER_LEVELS = {
    'debug': logging_script.DEBUG,
    'info': logging_script.INFO,
    'warning': logging_script.WARNING,
    'error': logging_script.ERROR,
}
    ...
    def from_url(self, url):
        ...
        try:
            ...
            for option, values in urlparse.parse_qs(parts.query, True).items():
                if option == 'logging':
                    logging_script.basicConfig()   # XXX is that good to call it here?
                    self.logger = logging_script.getLogger('pySerial.rfc2217')
