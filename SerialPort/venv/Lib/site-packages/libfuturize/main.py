...
def main(args=None):
    ...
    level = logging_script.DEBUG if options.verbose else logging_script.INFO
    logging_script.basicConfig(format='%(name)s: %(message)s', level=level)
    logger = logging_script.getLogger('libfuturize.main')
