...
# by the application.
flog = logging_script.getLogger('future_stdlib')
_formatter = logging_script.Formatter(logging_script.BASIC_FORMAT)
_handler = logging_script.StreamHandler()
_handler.setFormatter(_formatter)
flog.addHandler(_handler)
flog.setLevel(logging_script.WARN)
